    ...
    public void presentaMenu(String estado) {
       ...
       UtilidadesES.mostrarln("**MENÚ**");
        for (String opcion: opcionesMenu) {
            if("Parado".equals(estado) && (indice==1 || indice==3 || indice==4|| indice==7 )){
                UtilidadesES.mostrarln(i+ " "+opcion);
                i++;
                
            }else if("Lanzado".equals(estado) && (indice==2 || indice==3 || indice==4|| indice==7)){
                UtilidadesES.mostrarln(i+ " "+opcion);
                i++;
            }else if("Finalizado".equals(estado) && (indice==5 || indice==6|| indice==7)){
                UtilidadesES.mostrarln(i+ " "+opcion);
                i++;
            }
