...
public class Procesos{
    ...
    ArrayList<Usuario> loginsDuplicados = new ArrayList<Usuario>();
                        ...
                        if(login.equals(loginCerta)){
                            //Login encontrado
                             ...
                             if(!yaDentro){
                                 ...
                                 usuarios.remove(i);
                                 loginsDuplicados.add(new Usuario(lineas[0],lineas[1],lineas[2],lineas[3]));
                             } 
                        }
                    }
    ...
    public void mostrarDatos(){
        System.out.println(" -------- USUARIOS GUARDADOS:");
                ...
                System.out.println("----------- USUARIOS DUPLICADOS:");
                                for(int i=0; i<loginsDuplicados.size();i++){
                    System.out.println(" -------- ");
                    System.out.println("Login: " +loginsDuplicados.get(i).getLogin());
                    System.out.println("Password: " +loginsDuplicados.get(i).getPassword());
                    System.out.println("Mail: " +loginsDuplicados.get(i).getEmail());
                    System.out.println("Nombre Completo: " +loginsDuplicados.get(i).getNombreCompleto());
                }
    ...
    public void meterDatosEnNuevoArchivo() throws IOException{
            System.out.println("ARCHIVO PARA USUARIOS ACETPADOS");
    ...
    private void meterDatosDuplicados()  throws IOException{
          System.out.println("ARCHIVO PARA USUARIOS DUPLICADOS");
        ...
        if( DIRECCION.contains(".txt")){
                ...
                System.out.println("Archivo Creado");
                  for(int i=0; i<loginsDuplicados.size();i++){
                     printWriter.print(loginsDuplicados.get(i).getLogin()+ ":"+loginsDuplicados.get(i).getPassword()+ ":"+
                           loginsDuplicados.get(i).getEmail()+ ":"+loginsDuplicados.get(i).getNombreCompleto()+"\n");}
                  printWriter.close();
        }else{System.out.println("NOMBRE DE ARCHIVO NO VALIDO");}
        }catch(FileNotFoundException e){
            System.out.println("ARCHIVO CON NOMBRE INVALIDO");
