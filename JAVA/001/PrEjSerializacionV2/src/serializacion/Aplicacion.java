...
import serializacion.beans.Usuario;

import serializacion.utilidades.Serializar;
import serializacion.utilidades.UtilidadesES;
...
public class Aplicacion {
    ...
    public void ejecutar() throws FileNotFoundException, IOException, ClassNotFoundException {
        ...
        if (!fArchivo.exists()) {
            ...
            serializar.guardarObjeto(listaUsuarios, fArchivo);
